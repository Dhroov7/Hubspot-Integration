...
const REDIRECT_URI = `https://hubspot-internal.onrender.com/oauth-callback`;
...
const authUrl = `https://app.hubspot.com/oauth/authorize?client_id=${CLIENT_ID}&redirect_uri=https://hubspot-internal.onrender.com/oauth-callback&scope=oauth%20tickets%20crm.objects.owners.read%20conversations.read%20conversations.write`
